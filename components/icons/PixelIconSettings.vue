<template>
    <svg class="pixel-icon" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="38" cy="38" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="2" cy="10" r="2"  />
        <circle cx="2" cy="42" r="2"  />
        <circle cx="34" cy="10" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="34" cy="54" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="38" cy="10" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="38" cy="50" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="10" cy="38" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="42" cy="6" r="2"  />
        <circle cx="42" cy="38" r="2"  />
        <circle cx="10" cy="10" r="2"  />
        <circle cx="10" cy="42" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="42" cy="10" r="2"  />
        <circle cx="10" cy="14" r="2"  />
        <circle cx="10" cy="46" r="2"  />
        <circle cx="42" cy="14" r="2"  />
        <circle cx="42" cy="46" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="42" cy="42" r="2"  />
        <circle cx="10" cy="18" r="2"  />
        <circle cx="10" cy="50" r="2"  />
        <circle cx="42" cy="18" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="42" cy="50" r="2"  />
        <circle cx="10" cy="22" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="10" cy="54" r="2"  />
        <circle cx="42" cy="22" r="2"  />
        <circle cx="42" cy="54" r="2"  />
        <circle cx="10" cy="26" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="14" cy="34" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="14" cy="14" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="14" cy="46" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="46" cy="14" r="2"  />
        <circle cx="46" cy="46" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="14" cy="18" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="14" cy="50" r="2"  />
        <circle cx="46" cy="18" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="14" cy="30" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="50" cy="34" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="18" cy="46" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="50" cy="14" r="2"  />
        <circle cx="50" cy="46" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="18" cy="18" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="50" cy="26" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="50" cy="58" r="2"  />
        <circle cx="18" cy="30" r="2"  />
        <circle cx="18" cy="62" r="2"  />
        <circle cx="50" cy="30" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="54" cy="38" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="22" cy="10" r="2"  />
        <circle cx="54" cy="10" r="2"  />
        <circle cx="54" cy="42" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="30" cy="54" r="2" fill="var(--pixel-fill-color)" />
