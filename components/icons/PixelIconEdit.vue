<template>
    <svg class="pixel-icon" width="64" height="64" viewBox="0 0 64 64" fill="var(--S-40)" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="38" cy="38" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="6" cy="50" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="38" cy="18" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="38" cy="50" r="2" />
        <circle cx="6" cy="22" r="2" />
        <circle cx="6" cy="54" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="38" cy="22" r="2" />
        <circle cx="38" cy="54" r="2" />
        <circle cx="6" cy="26" r="2" />
        <circle cx="6" cy="58" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="42" cy="18" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="10" cy="58" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="46" cy="6" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="46" cy="22" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="50" cy="6" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="18" cy="46" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="30" cy="46" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="58" cy="14" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="58" cy="46" r="2" />
        <circle cx="26" cy="50" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="34" cy="38" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="34" cy="14" r="2" />
        <circle cx="34" cy="18" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="34" cy="22" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="38" cy="34" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="38" cy="14" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="10" cy="54" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="42" cy="30" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="14" cy="38" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="14" cy="42" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="46" cy="10" r="2" />
        <circle cx="14" cy="46" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="46" cy="26" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="18" cy="34" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="18" cy="38" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="50" cy="14" r="2" />
        <circle cx="18" cy="50" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="50" cy="18" r="2" />
        <circle cx="50" cy="22" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="54" cy="10" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="26" cy="46" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="22" cy="50" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="54" cy="18" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        <circle cx="22" cy="22" r="2" />
        <circle cx="22" cy="30" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="30" cy="22" r="2" id="active-pix" fill="var(--pixel-fill-color)" />
