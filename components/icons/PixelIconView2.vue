<template>
    <svg class="pixel-icon" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="34" cy="38" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="6" cy="34" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="38" cy="2" r="2" />
        <circle cx="38" cy="34" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="38" cy="42" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="6" cy="30" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="6" cy="62" r="2" />
        <circle cx="38" cy="30" r="2" />
        <circle cx="38" cy="62" r="2" />
        <circle cx="10" cy="2" r="2" />
        <circle cx="10" cy="34" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="42" cy="14" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="10" cy="30" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="18" cy="50" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="50" cy="18" r="2" />
        <circle cx="50" cy="50" r="2" />
        <circle cx="18" cy="22" r="2" />
        <circle cx="18" cy="54" r="2" />
        <circle cx="50" cy="22" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="54" cy="34" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="22" cy="14" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="22" cy="46" r="2" fill="var(--pixel-fill-color)" />
        <circle cx="26" cy="46" r="2" />
        <circle cx="30" cy="46" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="54" cy="30" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="58" cy="30" r="2" fill="var(--pixel-fill-color)" />
        ...
        <circle cx="30" cy="38" r="2" fill="var(--pixel-fill-color)" />
